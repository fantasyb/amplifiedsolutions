...
export default function HowItWorksSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-16 md:py-20 lg:py-24 bg-gradient-to-br from-[#f4f2ed] to-gray-50 overflow-hidden">
      ...
      {/* Floating elements */}
      <div className="absolute top-20 left-20 w-32 h-32 bg-[#FFD580]/10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-green-200/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-6"
            ...
            <span className="relative">
              ...
              <span className={`absolute bottom-1 left-0 w-full h-3 bg-[#FFD580] opacity-70 rounded-full transition-all duration-700 delay-300 ${isVisible ? 'scale-x-100' : 'scale-x-0'}`}
                    style={{
          ...
          <div className="flex justify-center mb-8">
            <div className={`w-16 h-1 bg-[#FFD580] rounded-full transition-all duration-500 delay-500 ${isVisible ? 'scale-x-100' : 'scale-x-0'}`}></div>
          </div>
        ...
        <div className={`bg-white/95 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-white/20 transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Metric 1 */}
            <div className="text-center p-6 bg-gradient-to-br from-[#FFD580] to-[#ffcf66] rounded-xl hover:scale-105 transition-transform duration-300 shadow-lg">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
                <svg className="w-6 h-6 text-[#647b75]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </div>
              <h4 className="font-bold text-gray-800 mb-2">Contact Activity</h4>
              <p className="text-sm text-gray-700">Calls, texts, emails sent and response rates</p>
            </div>

            {/* Metric 2 */}
            <div className="text-center p-6 bg-gradient-to-br from-[#9fe2bf] to-[#7dd3fc] rounded-xl hover:scale-105 transition-transform duration-300 shadow-lg">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
                <svg className="w-6 h-6 text-[#647b75]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h4 className="font-bold text-gray-800 mb-2">Agent Performance</h4>
              <p className="text-sm text-gray-700">Response times and follow-up activity</p>
            </div>

            {/* Metric 3 */}
            <div className="text-center p-6 bg-gradient-to-br from-[#647b75] to-[#5a6f69] rounded-xl hover:scale-105 transition-transform duration-300 shadow-lg">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
                <svg className="w-6 h-6 text-[#647b75]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h4 className="font-bold text-white mb-2">Lead Pipeline</h4>
              <p className="text-sm text-white">Stage movement and progression tracking</p>
            </div>

            {/* Metric 4 */}
            <div className="text-center p-6 bg-gradient-to-br from-green-500 to-green-600 rounded-xl hover:scale-105 transition-transform duration-300 shadow-lg">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
              ...
              <p className="text-sm text-white">Appointments and live transfers delivered</p>
            </div>
          </div>
        </div>
      </div>
