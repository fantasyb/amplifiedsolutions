          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 w-full">
            <div className="max-w-3xl">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-normal text-white mb-8 leading-tight"
                ...
                We build Follow Up Boss systems that convert leads into clients.
              </h1>
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-2xl leading-relaxed mb-12 font-light">
                Complete CRM optimization with action plans, smart lists, ponds, and automations designed to help your team close more deals.
              </p>
      ...
      <section className="py-32 bg-gradient-to-br from-[#9fe2bf] to-[#8dd9b1] relative">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-16">
            A properly configured Follow Up Boss system transforms how your team works. Stop losing leads to poor follow-up and start converting more opportunities.
          </p>

          <div className="grid md:grid-cols-4 gap-8 mb-16">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8">
              <div className="text-5xl font-black text-[#647b75] mb-4">24+</div>
              <div className="text-gray-700 font-semibold">Action Plans</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8">
              <div className="text-5xl font-black text-[#647b75] mb-4">10</div>
              <div className="text-gray-700 font-semibold">Smart Lists</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8">
              <div className="text-5xl font-black text-[#647b75] mb-4">90</div>
              <div className="text-gray-700 font-semibold">Days Support</div>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8">
              <div className="text-5xl font-black text-[#647b75] mb-4">1:1</div>
              <div className="text-gray-700 font-semibold">Training</div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
              Get a complete Follow Up Boss system built for automation. We handle your entire CRM setup—action plans, smart lists, ponds, workflows, and ongoing support.
            </p>
            <button
              onClick={openModal}
      ...
      <section className="py-32 bg-gradient-to-r from-[#647b75] to-[#5a6d66] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center">
          <h3 className="text-5xl md:text-6xl font-black text-white mb-8 leading-tight">
            ...
            <span className="text-[#FFD580]"> Follow Up Boss?</span>
          </h3>
          <p className="text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
            Join real estate teams who have transformed their CRM from a data dump into a conversion machine with proven systems and automation.
          </p>
